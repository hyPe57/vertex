...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full px-4 lg:px-6 py-4 space-y-4">
      {/* Main Split-Column Workspace: QuickLog at the very top edge on the right */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        {/* Left Column (8 cols): Stats Cards row + Equity Curve Card */}
        <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-3.5">
          {/* Top Row: Compact 6 Stats Cards */}
          <StatsCards />
        ...
        {/* Right Column (4 cols): QuickLog - FLUSH WITH THE VERY TOP EDGE */}
